...
EAPI Enesim_Surface * enesim_surface_new(Enesim_Backend b, Enesim_Format f, uint32_t w, uint32_t h);
EAPI Enesim_Surface * enesim_surface_new_data_from(Enesim_Backend b, Enesim_Format f, uint32_t w, uint32_t h, Enesim_Buffer_Data *data);
