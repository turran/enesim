 ...
 *============================================================================*/
/** @cond internal */
typedef struct _Enesim_Text_Buffer_Ansi
{
	char *string;
	size_t length; /* string length */
	size_t bytes; /* alloced length */
} Enesim_Text_Buffer_Ansi;
/*----------------------------------------------------------------------------*
 *                           Text buffer interface                            *
 *----------------------------------------------------------------------------*/
static const char * _ansi_type_get(void)
{
	return "enesim.text.buffer.ansi";
}

static void _ansi_string_set(void *data, const char *string, int length)
{
	Enesim_Text_Buffer_Ansi *thiz = data;
...
static int _ansi_string_insert(void *data, const char *string, int length, ssize_t offset)
{
	Enesim_Text_Buffer_Ansi *thiz = data;
...
static int _ansi_string_delete(void *data, int length, ssize_t offset)
{
	Enesim_Text_Buffer_Ansi *thiz = data;
...
static const char * _ansi_string_get(void *data)
{
	Enesim_Text_Buffer_Ansi *thiz = data;
	return thiz->string;
}

static int _ansi_string_length(void *data)
{
	Enesim_Text_Buffer_Ansi *thiz = data;
	return thiz->length;
}

static void _ansi_free(void *data)
{
	Enesim_Text_Buffer_Ansi *thiz = data;
...
/* the ansi buffer */
static Enesim_Text_Buffer_Descriptor _enesim_text_buffer_ansi = {
	/* .type_get 		= */ _ansi_type_get,
	/* .string_get 		= */ _ansi_string_get,
	/* .string_set 		= */ _ansi_string_set,
	/* .string_insert 	= */ _ansi_string_insert,
	/* .string_delete 	= */ _ansi_string_delete,
	/* .string_length 	= */ _ansi_string_length,
	/* .free 		= */ _ansi_free,
};
/*============================================================================*
 *                                 Global                                     *
...
{
	Enesim_Text_Buffer_Ansi *thiz;

	thiz = calloc(1, sizeof(Enesim_Text_Buffer_Ansi));
	if (initial_length <= 0)
	...
	return enesim_text_buffer_new_from_descriptor(&_enesim_text_buffer_ansi, thiz);
}
