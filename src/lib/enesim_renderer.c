 ...
 * @param[out] x The origin X coordinate
 * @param[out] y The origin Y coordinate
 */
 ...
 * @param[in] mask The mask renderer to use [transfer full]
 *
 * A renderer can be masked by the pixels generated by another renderer.
 * This functions sets such renderer
 */
 ...
 * @return The mask renderer [transfer none]
 */
 ...
 * the @a ENESIM_RENDERER_FEATURE_QUALITY
 */
