...
#define ENESIM_RENDERER_PATH_KIIA_GET_ALPHA enesim_renderer_path_kiia_8_even_odd_get_alpha
...
static inline uint16_t enesim_renderer_path_kiia_8_even_odd_get_alpha(int cm)
{
	uint16_t coverage;
...
ENESIM_RENDERER_PATH_KIIA_WORKER_SETUP(8, even_odd)
/** @endcond */
/*============================================================================*
 *                                   API                                      *
 *============================================================================*/
