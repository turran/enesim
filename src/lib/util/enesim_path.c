...
static void _full_path_vertex_process(double x, double y, Enesim_Path_Full *thiz)
{
	Enesim_Polygon *inset = thiz->inset_polygon;
	Enesim_Polygon *offset = thiz->offset_polygon;
	Enesim_Point o0, o1;
...
static void _full_path_vertex_add(double x, double y, void *data)
{
	Enesim_Path_Full *thiz = data;

	enesim_polygon_point_append_from_coords(thiz->original_polygon, x, y);
	_full_path_vertex_process(x, y, thiz);
}

static void _full_path_polygon_add(void *data)
{
        Enesim_Path_Full *thiz = data;
	Enesim_Path *path = thiz->p;
        Enesim_Polygon *p;
...
static void _full_path_polygon_close(Eina_Bool close, void *data)
{
        Enesim_Path_Full *thiz = data;
...
static void _full_path_begin(void *data)
{
	Enesim_Path_Full *thiz = data;
	Enesim_Path *path = thiz->p;
...
static void _full_path_done(void *data)
{
        Enesim_Path_Full *thiz = data;
